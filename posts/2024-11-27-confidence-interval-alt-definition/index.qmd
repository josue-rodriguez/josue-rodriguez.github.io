...
[Wikipedia give this as one interpretation of a confidence interval](https://en.wikipedia.org/wiki/Confidence_interval#Interpretation)
...
t.test(x, mu = 49.5)$p.value
t.test(x, mu = 57)$p.value
```
